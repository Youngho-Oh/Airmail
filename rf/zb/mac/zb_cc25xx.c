...
#include "rf/zb/hdr/zb_mac_transport.h"
...
{
	IEEE_ADDR = ZB_PIB_EXTENDED_ADDRESS()[0];
	IEEE_ADDR_6th = ZB_PIB_EXTENDED_ADDRESS()[1];
	IEEE_ADDR_5th = ZB_PIB_EXTENDED_ADDRESS()[2];
	IEEE_ADDR_4th = ZB_PIB_EXTENDED_ADDRESS()[3];
	IEEE_ADDR_3rd = ZB_PIB_EXTENDED_ADDRESS()[4];
	IEEE_ADDR_2nd = ZB_PIB_EXTENDED_ADDRESS()[5];
	IEEE_ADDR_1st = ZB_PIB_EXTENDED_ADDRESS()[6];
	IEEE_ADDR_LSB = ZB_PIB_EXTENDED_ADDRESS()[7];
}

void zb_set_pan_id(zb_uint16_t pan_id)
{
	PANIDH = (pan_id &0xFF);
	PANIDL = ((pan_id>>8)&0xFF);
}
