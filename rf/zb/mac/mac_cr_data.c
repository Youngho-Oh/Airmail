...
//    MAC_CTX().mac_storage.mac_data_req.mhr_pend = mhr_pend;
    memcpy(&MAC_CTX().mac_storage.mac_data_req.mhr_pend, &mhr_pend, sizeof(zb_mac_mhr_t));
...
//  mhr_pend = MAC_CTX().mac_storage.mac_data_req.mhr_pend;
  memcpy(&mhr_pend, &MAC_CTX().mac_storage.mac_data_req.mhr_pend, sizeof(zb_mac_mhr_t));
