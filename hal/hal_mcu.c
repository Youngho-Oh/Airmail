...
void halMcuInit(void)
{
  ...
  if(clockSelect32k(CLOCK_32K_XTAL) != true) {
...
//      HAL_ASSERT(FALSE);
  ...
  //WOW Setting pin using system functions
  halPinInit();
}
...
*/
#pragma optimize=none
void halMcuWaitMs(unsigned short msec)
{
    while(msec--)
        halMcuWaitUs(1000);
}
...
* @return      none
*/
void halMcuSetLowPowerMode(unsigned char mode)
{
...
{
    const unsigned char WDT_INTERVAL_MSEC_2=                    0x03;   // after ~2 ms
