...
#define CC2530_IS_HFRC_STABLE()    (SLEEPSTA & SLEEP_HFRC_STB_BM)

// Macro for checking status of the crystal oscillator
#define CC2530_IS_XOSC_STABLE()    (SLEEPSTA & SLEEP_XOSC_STB_BM)

// Macro for getting the clock division factor
#define CC2530_GET_CLKSPD()        (CLKCONSTA & CLKCON_CLKSPD_BM)


// Macro for getting the timer tick division factor.
#define CC2530_GET_TICKSPD()       ((CLKCONSTA & CLKCON_TICKSPD_BM) >> 3)
...
bool clockSelect32k(unsigned char source);
