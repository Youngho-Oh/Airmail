...
$(PROJECT_NAME).hex : $(PROJECT_NAME).ihx
	...
	srec_cat -disable_sequence_warnings $< -intel -crop 0x68000 0x6FFFF -offset -229376 -o bank6.hex -intel
	srec_cat -disable_sequence_warnings $< -intel -crop 0x78000 0x7FFFF -offset -262144 -o bank7.hex -intel
	srec_cat -disable_sequence_warnings $< -intel -crop 0x00000 0x07FFF -o home.ihx -intel
	srec_cat home.ihx -intel bank1.hex -intel bank2.hex -intel bank3.hex -intel bank4.hex -intel bank5.hex -intel bank6.hex -intel bank7.hex -intel -o $@ -intel
	rm -fr home.ihx bank1.hex bank2.hex bank3.hex bank4.hex bank5.hex bank6.hex bank7.hex
